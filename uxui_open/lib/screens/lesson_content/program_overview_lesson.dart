          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                RichText(
                  text: const TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: 'Day One', style: TextStyle(color: AppColors.coral, fontWeight: FontWeight.bold)),
                ...
                const SizedBox(height: 16),
                buildBulletPoint('How to conduct an effective job search that will result in a tech job that you will genuinely enjoy'),
                buildBulletPoint('How to build a network of mentors and peers to lean on, learn from, and collaborate with as you progress throughout your new tech career'),
                buildBulletPoint('How to present yourself through your resume, LinkedIn profile, online portfolio, and other online presence in the best possible light'),
                buildBulletPoint('How to pass technical screens, take home assignments, and non-technical interviews'),
                buildBulletPoint('How to negotiate effectively and get paid what you are worth as a professional'),
                const SizedBox(height: 32),
                Container(
                  width: double.infinity,
                  padding: const EdgeInsets.all(24),
                ...
                RichText(
                  text: const TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(text: '\$100 - \$200', style: TextStyle(color: AppColors.coral, fontWeight: FontWeight.bold)),
                ...
                buildBulletPoint('Why did you enroll for the program? (Learning goals for this course)'),
                ...
                buildBulletPoint('Keep your access over your FULL student period 🤩'),
                buildBulletPoint('Our course updates you on the new trends etc. ✨'),
